...
// For similar Posts
                  $limitposts = $this->db->select('*')->order_by('rand()')->limit('6')->where('category_id',$post->category_id)->where('status_ind',1)->where('post_id !=',$post->post_id)->get('blog')->result();
            ...
            <div class="widget">
             ...
             <?php foreach ($limitposts as $limitpost) { ?>
                <article class="post clearfix pb-0 mb-20">
                    <a class="post-thumb" href="blog/post/<?php echo $limitpost->page_slug; ?>"><img src="<?php echo BLOG_PHOTO_UPLOAD_PATH.$limitpost->post_image; ?>" alt="images"></a>
                    <div class="post-right">
                      <h5 class="post-title mt-0"><a href="blog/post/<?php echo $limitpost->page_slug; ?>"><?php echo $limitpost->title; ?></a></h5>
                      <span class="post-date">  
                        <time class="entry-date" datetime="<?php echo $limitpost->created_at; ?>"><?php echo $limitpost->created_at; ?></time>
                      </span>
                    </div>
                  </article>
                  <?php } ?>
